  ...
  appEmitter.on('ws-event', (client, mesg) => {
    ...
    switch (event) {
      ...
      case 'overview-rollback':
        ...
        switch (id) {
          case 3:
            appEmitter.emit('plc-write', 0x84, s7def.DB_DATA, ((184 * 8) + 4), 1, 0x01, s7def.TRUE)
            break
          case 4:
            appEmitter.emit('plc-write', 0x84, s7def.DB_DATA, ((184 * 8) + 5), 1, 0x01, s7def.TRUE)
            break
        }
        break
    }
