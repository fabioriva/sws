...
var alarms3 = []
for (let a = 0; a < 64; a++) {
  alarms3.push(new Alarm(a + 1, 2, 0))
}
alarms3.forEach((a, i) => {
...
var alarms4 = []
for (let a = 0; a < 64; a++) {
  alarms4.push(new Alarm(a + 1, 2, 0))
}
alarms4.forEach((a, i) => {
...
var outputs3 = generateBits('A', 110, 111)
...
const SILOMAT_1 = [
  ...
  outputs3.find(b => b.addr === 'A110.1'),
  outputs3.find(b => b.addr === 'A110.2'),
  outputs3.find(b => b.addr === 'A110.3'),
...
const SILOMAT_2 = [
  ...
  outputs5.find(b => b.addr === 'A210.1'),
  outputs5.find(b => b.addr === 'A210.2'),
  outputs5.find(b => b.addr === 'A210.3'),
